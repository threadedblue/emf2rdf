...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Int5</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link littleints.thoseInts.impl.Int5Impl#isBoolVal <em>Bool Val</em>}</li>
 *   <li>{@link littleints.thoseInts.impl.Int5Impl#getDoubVal <em>Doub Val</em>}</li>
 *   <li>{@link littleints.thoseInts.impl.Int5Impl#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link littleints.thoseInts.impl.Int5Impl#getHlaType <em>Hla Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Int5Impl extends MinimalEObjectImpl.Container implements Int5 {
	/**
	...
	protected EClass eStaticClass() {
		return ThoseIntsPackage.Literals.INT5;
	}
	...
	public void setBoolVal(boolean newBoolVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThoseIntsPackage.INT5__BOOL_VAL, oldBoolVal, boolVal));
	}
	...
	public void setDoubVal(double newDoubVal) {
		...
		doubVal = newDoubVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThoseIntsPackage.INT5__DOUB_VAL, oldDoubVal, doubVal));
	}
	...
	public void setStrVal(String newStrVal) {
		...
		strVal = newStrVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThoseIntsPackage.INT5__STR_VAL, oldStrVal, strVal));
	}
	...
	public HLAInteraction getHlaType() {
		if (hlaType != null && hlaType.eIsProxy()) {
			...
			if (hlaType != oldHlaType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThoseIntsPackage.INT5__HLA_TYPE, oldHlaType, hlaType));
			}
		}
		return hlaType;
	}
	...
	public void setHlaType(HLAInteraction newHlaType) {
		...
		hlaType = newHlaType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThoseIntsPackage.INT5__HLA_TYPE, oldHlaType, hlaType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThoseIntsPackage.INT5__BOOL_VAL:
				return isBoolVal();
			case ThoseIntsPackage.INT5__DOUB_VAL:
				return getDoubVal();
			case ThoseIntsPackage.INT5__STR_VAL:
				return getStrVal();
			case ThoseIntsPackage.INT5__HLA_TYPE:
