...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Int3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link littleints.theseints.impl.Int3Impl#isBoolVal <em>Bool Val</em>}</li>
 *   <li>{@link littleints.theseints.impl.Int3Impl#getDoubVal <em>Doub Val</em>}</li>
 *   <li>{@link littleints.theseints.impl.Int3Impl#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link littleints.theseints.impl.Int3Impl#getHlaType <em>Hla Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Int3Impl extends MinimalEObjectImpl.Container implements Int3 {
	/**
	...
	protected EClass eStaticClass() {
		return TheseintsPackage.Literals.INT3;
	}
	...
	public void setBoolVal(boolean newBoolVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT3__BOOL_VAL, oldBoolVal, boolVal));
	}
	...
	public void setDoubVal(double newDoubVal) {
		...
		doubVal = newDoubVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT3__DOUB_VAL, oldDoubVal, doubVal));
	}
	...
	public void setStrVal(String newStrVal) {
		...
		strVal = newStrVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT3__STR_VAL, oldStrVal, strVal));
	}
	...
	public HLAInteraction getHlaType() {
		if (hlaType != null && hlaType.eIsProxy()) {
			...
			if (hlaType != oldHlaType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TheseintsPackage.INT3__HLA_TYPE, oldHlaType, hlaType));
			}
		}
		return hlaType;
	}
	...
	public void setHlaType(HLAInteraction newHlaType) {
		...
		hlaType = newHlaType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT3__HLA_TYPE, oldHlaType, hlaType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TheseintsPackage.INT3__BOOL_VAL:
				return isBoolVal();
			case TheseintsPackage.INT3__DOUB_VAL:
				return getDoubVal();
			case TheseintsPackage.INT3__STR_VAL:
				return getStrVal();
			case TheseintsPackage.INT3__HLA_TYPE:
