...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Int2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link littleints.theseints.impl.Int2Impl#isBoolVal <em>Bool Val</em>}</li>
 *   <li>{@link littleints.theseints.impl.Int2Impl#getDoubVal <em>Doub Val</em>}</li>
 *   <li>{@link littleints.theseints.impl.Int2Impl#getStrVal <em>Str Val</em>}</li>
 *   <li>{@link littleints.theseints.impl.Int2Impl#getHlaType <em>Hla Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Int2Impl extends MinimalEObjectImpl.Container implements Int2 {
	/**
	...
	protected EClass eStaticClass() {
		return TheseintsPackage.Literals.INT2;
	}
	...
	public void setBoolVal(boolean newBoolVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT2__BOOL_VAL, oldBoolVal, boolVal));
	}
	...
	public void setDoubVal(double newDoubVal) {
		...
		doubVal = newDoubVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT2__DOUB_VAL, oldDoubVal, doubVal));
	}
	...
	public void setStrVal(String newStrVal) {
		...
		strVal = newStrVal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT2__STR_VAL, oldStrVal, strVal));
	}
	...
	public HLAInteraction getHlaType() {
		if (hlaType != null && hlaType.eIsProxy()) {
			...
			if (hlaType != oldHlaType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TheseintsPackage.INT2__HLA_TYPE, oldHlaType, hlaType));
			}
		}
		return hlaType;
	}
	...
	public void setHlaType(HLAInteraction newHlaType) {
		...
		hlaType = newHlaType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TheseintsPackage.INT2__HLA_TYPE, oldHlaType, hlaType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TheseintsPackage.INT2__BOOL_VAL:
				return isBoolVal();
			case TheseintsPackage.INT2__DOUB_VAL:
				return getDoubVal();
			case TheseintsPackage.INT2__STR_VAL:
				return getStrVal();
			case TheseintsPackage.INT2__HLA_TYPE:
